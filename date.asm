...
main(int argc, char *argv[])
{
  ...
  10:	e8 2d 03 00 00       	call   342 <date>
  15:	85 c0                	test   %eax,%eax
  17:	74 19                	je     32 <main+0x32>
    printf(2, "date failed\n");
  19:	c7 44 24 04 56 07 00 	movl   $0x756,0x4(%esp)
  20:	00 
  21:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  28:	e8 c3 03 00 00       	call   3f0 <printf>
    exit();
  2d:	e8 70 02 00 00       	call   2a2 <exit>
  }
  //code to print date
  else {
    printf(1, "%d-%d-%d %d:%d:%d\n", r.year, r.month, r.day, r.hour, r.minute, r.second);
  32:	8b 44 24 28          	mov    0x28(%esp),%eax
  36:	c7 44 24 04 63 07 00 	movl   $0x763,0x4(%esp)
  3d:	00 
  3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  45:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  49:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  4d:	89 44 24 18          	mov    %eax,0x18(%esp)
  51:	8b 44 24 30          	mov    0x30(%esp),%eax
  55:	89 44 24 14          	mov    %eax,0x14(%esp)
  59:	8b 44 24 34          	mov    0x34(%esp),%eax
  5d:	89 44 24 10          	mov    %eax,0x10(%esp)
  61:	8b 44 24 38          	mov    0x38(%esp),%eax
  65:	89 44 24 0c          	mov    %eax,0xc(%esp)
  69:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  6d:	89 44 24 08          	mov    %eax,0x8(%esp)
  71:	e8 7a 03 00 00       	call   3f0 <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 389:	0f b6 92 7d 07 00 00 	movzbl 0x77d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 76 07 00 00       	mov    $0x776,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 f4 09 00 00       	mov    0x9f4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 627:	89 10                	mov    %edx,(%eax)
  freep = p;
 629:	a3 f4 09 00 00       	mov    %eax,0x9f4
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 652:	a3 f4 09 00 00       	mov    %eax,0x9f4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 1d f4 09 00 00    	mov    0x9f4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6b9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6bb:	3b 15 f4 09 00 00    	cmp    0x9f4,%edx
...
morecore(uint nu)
{
 ...
 6ed:	e8 ee fe ff ff       	call   5e0 <free>
  return freep;
 6f2:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 714:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 717:	89 15 f4 09 00 00    	mov    %edx,0x9f4
      return (void*)(p + 1);
 ...
 72c:	eb e9                	jmp    717 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72e:	c7 05 f4 09 00 00 f8 	movl   $0x9f8,0x9f4
 735:	09 00 00 
    base.s.size = 0;
 738:	ba f8 09 00 00       	mov    $0x9f8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73d:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 744:	09 00 00 
    base.s.size = 0;
 747:	c7 05 fc 09 00 00 00 	movl   $0x0,0x9fc
 74e:	00 00 00 
