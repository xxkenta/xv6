...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 9b 75 10 80 	movl   $0x8010759b,(%esp)
...
801011a5:	c7 04 24 df 6c 10 80 	movl   $0x80106cdf,(%esp)
...
801012cc:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012cd:	c7 04 24 f5 6c 10 80 	movl   $0x80106cf5,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101387:	c7 04 24 05 6d 10 80 	movl   $0x80106d05,(%esp)
...
80101468:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101469:	c7 04 24 18 6d 10 80 	movl   $0x80106d18,(%esp)
...
8010148c:	c7 44 24 04 2b 6d 10 	movl   $0x80106d2b,0x4(%esp)
80101493:	80 
...
801014a9:	c7 44 24 04 32 6d 10 	movl   $0x80106d32,0x4(%esp)
801014b0:	80 
...
801014d6:	c7 04 24 98 6d 10 80 	movl   $0x80106d98,(%esp)
...
801015ec:	e9 2f fc ff ff       	jmp    80101220 <iget>
  ...
  panic("ialloc: no inodes");
801015f1:	c7 04 24 38 6d 10 80 	movl   $0x80106d38,(%esp)
...
80101774:	0f 85 76 ff ff ff    	jne    801016f0 <ilock+0x30>
      panic("ilock: no type");
8010177a:	c7 04 24 50 6d 10 80 	movl   $0x80106d50,(%esp)
80101781:	e8 da eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101786:	c7 04 24 4a 6d 10 80 	movl   $0x80106d4a,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017d3:	c7 04 24 5f 6d 10 80 	movl   $0x80106d5f,(%esp)
...
80101c71:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
80101c72:	c7 04 24 79 6d 10 80 	movl   $0x80106d79,(%esp)
80101c79:	e8 e2 e6 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101c7e:	c7 04 24 67 6d 10 80 	movl   $0x80106d67,(%esp)
...
80101ef3:	eb e9                	jmp    80101ede <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101ef5:	c7 04 24 88 6d 10 80 	movl   $0x80106d88,(%esp)
80101efc:	e8 5f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101f01:	c7 04 24 82 73 10 80 	movl   $0x80107382,(%esp)
...
80101fef:	c7 04 24 f4 6d 10 80 	movl   $0x80106df4,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101ffb:	c7 04 24 eb 6d 10 80 	movl   $0x80106deb,(%esp)
...
80102016:	c7 44 24 04 06 6e 10 	movl   $0x80106e06,0x4(%esp)
8010201d:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801021eb:	c7 04 24 0a 6e 10 80 	movl   $0x80106e0a,(%esp)
801021f2:	e8 69 e1 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
801021f7:	c7 04 24 35 6e 10 80 	movl   $0x80106e35,(%esp)
801021fe:	e8 5d e1 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
80102203:	c7 04 24 20 6e 10 80 	movl   $0x80106e20,(%esp)
...
80102258:	c7 04 24 54 6e 10 80 	movl   $0x80106e54,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010238e:	c7 04 24 86 6e 10 80 	movl   $0x80106e86,(%esp)
...
801023fb:	c7 44 24 04 8c 6e 10 	movl   $0x80106e8c,0x4(%esp)
80102402:	80 
...
80102544:	0f b6 81 c0 6f 10 80 	movzbl -0x7fef9040(%ecx),%eax
...
80102578:	0f b6 91 c0 6f 10 80 	movzbl -0x7fef9040(%ecx),%edx
  shift ^= togglecode[data];
8010257f:	0f b6 81 c0 6e 10 80 	movzbl -0x7fef9140(%ecx),%eax
    // Last character was an E0 escape; or with 0x80
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
8010258f:	8b 04 85 a0 6e 10 80 	mov    -0x7fef9160(,%eax,4),%eax
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
80102a8b:	c7 44 24 04 c0 70 10 	movl   $0x801070c0,0x4(%esp)
80102a92:	80 
...
80102cb2:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102cb3:	c7 04 24 c4 70 10 80 	movl   $0x801070c4,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102d70:	c7 04 24 d3 70 10 80 	movl   $0x801070d3,(%esp)
80102d77:	e8 e4 d5 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102d7c:	c7 04 24 e9 70 10 80 	movl   $0x801070e9,(%esp)
...
80102da7:	c7 04 24 04 71 10 80 	movl   $0x80107104,(%esp)
...
80102de3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102de6:	e8 85 37 00 00       	call   80106570 <switchkvm>
  seginit();
80102deb:	e8 c0 36 00 00       	call   801064b0 <seginit>
  lapicinit();
...
80102e23:	e8 d8 3b 00 00       	call   80106a00 <kvmalloc>
...
80102e35:	e8 76 36 00 00       	call   801064b0 <seginit>
  picinit();       // disable pic
...
80102e4a:	e8 81 29 00 00       	call   801057d0 <uartinit>
80102e4f:	90                   	nop
  pinit();         // process table
80102e50:	e8 9b 07 00 00       	call   801035f0 <pinit>
  tvinit();        // trap vectors
80102e55:	e8 b6 25 00 00       	call   80105410 <tvinit>
  binit();         // buffer cache
...
80102f4f:	00 
80102f50:	c7 44 24 04 18 71 10 	movl   $0x80107118,0x4(%esp)
80102f57:	80 
...
8010300a:	00 
8010300b:	c7 44 24 04 1d 71 10 	movl   $0x8010711d,0x4(%esp)
80103012:	80 
...
8010309c:	ff 24 8d 5c 71 10 80 	jmp    *-0x7fef8ea4(,%ecx,4)
801030a3:	90                   	nop
...
80103127:	0f 85 c5 fe ff ff    	jne    80102ff2 <mpinit+0x52>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
8010312d:	c7 04 24 22 71 10 80 	movl   $0x80107122,(%esp)
...
80103148:	eb e3                	jmp    8010312d <mpinit+0x18d>
  ...
  if(!ismp)
    panic("Didn't find a suitable machine");
8010314a:	c7 04 24 3c 71 10 80 	movl   $0x8010713c,(%esp)
...
801031ef:	c7 44 24 04 70 71 10 	movl   $0x80107170,0x4(%esp)
801031f6:	80 
...
8010353d:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103540:	c7 40 14 f8 53 10 80 	movl   $0x801053f8,0x14(%eax)
...
801035f6:	c7 44 24 04 75 71 10 	movl   $0x80107175,0x4(%esp)
801035fd:	80 
...
80103668:	eb ea                	jmp    80103654 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010366a:	c7 04 24 7c 71 10 80 	movl   $0x8010717c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103676:	c7 04 24 58 72 10 80 	movl   $0x80107258,(%esp)
...
801036f3:	e8 78 32 00 00       	call   80106970 <setupkvm>
...
80103715:	80 
80103716:	e8 85 2f 00 00       	call   801066a0 <inituvm>
  p->sz = PGSIZE;
...
80103792:	00 
80103793:	c7 44 24 04 a5 71 10 	movl   $0x801071a5,0x4(%esp)
8010379a:	80 
8010379b:	89 04 24             	mov    %eax,(%esp)
8010379e:	e8 cd 0c 00 00       	call   80104470 <safestrcpy>
  p->cwd = namei("/");
801037a3:	c7 04 24 ae 71 10 80 	movl   $0x801071ae,(%esp)
...
801037d6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037d7:	c7 04 24 8c 71 10 80 	movl   $0x8010718c,(%esp)
...
80103819:	e8 c2 2f 00 00       	call   801067e0 <allocuvm>
...
80103827:	e8 64 2d 00 00       	call   80106590 <switchuvm>
  return 0;
...
8010384a:	e8 81 30 00 00       	call   801068d0 <deallocuvm>
...
8010388e:	e8 bd 31 00 00       	call   80106a50 <copyuvm>
...
801039c2:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
801039c5:	e8 c6 2b 00 00       	call   80106590 <switchuvm>
      p->state = RUNNING;
...
801039db:	e8 eb 0a 00 00       	call   801044cb <swtch>
      switchkvm();
801039e0:	e8 8b 2b 00 00       	call   80106570 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103a7d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103a7e:	c7 04 24 b0 71 10 80 	movl   $0x801071b0,(%esp)
80103a85:	e8 d6 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103a8a:	c7 04 24 dc 71 10 80 	movl   $0x801071dc,(%esp)
80103a91:	e8 ca c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103a96:	c7 04 24 ce 71 10 80 	movl   $0x801071ce,(%esp)
80103a9d:	e8 be c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103aa2:	c7 04 24 c2 71 10 80 	movl   $0x801071c2,(%esp)
...
80103ba6:	e8 65 fe ff ff       	call   80103a10 <sched>
  panic("zombie exit");
80103bab:	c7 04 24 fd 71 10 80 	movl   $0x801071fd,(%esp)
80103bb2:	e8 a9 c7 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103bb7:	c7 04 24 f0 71 10 80 	movl   $0x801071f0,(%esp)
...
80103c9e:	c7 04 24 0f 72 10 80 	movl   $0x8010720f,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103caa:	c7 04 24 09 72 10 80 	movl   $0x80107209,(%esp)
...
80103d48:	e8 a3 2b 00 00       	call   801068f0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 9b 75 10 80 	movl   $0x8010759b,(%esp)
...
80103eba:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103ebd:	ba 20 72 10 80       	mov    $0x80107220,%edx
  uint pc[10];
...
80103ec4:	8b 14 85 80 72 10 80 	mov    -0x7fef8d80(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103ecb:	b8 20 72 10 80       	mov    $0x80107220,%eax
...
80103ee0:	c7 04 24 24 72 10 80 	movl   $0x80107224,(%esp)
...
80103f29:	c7 04 24 61 6c 10 80 	movl   $0x80106c61,(%esp)
...
80103f5a:	c7 44 24 04 98 72 10 	movl   $0x80107298,0x4(%esp)
80103f61:	80 
...
801041b7:	eb ac                	jmp    80104165 <acquire+0x15>
    panic("acquire");
801041b9:	c7 04 24 a3 72 10 80 	movl   $0x801072a3,(%esp)
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010421a:	c7 04 24 c2 72 10 80 	movl   $0x801072c2,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104226:	c7 04 24 ab 72 10 80 	movl   $0x801072ab,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104251:	c7 04 24 c9 72 10 80 	movl   $0x801072c9,(%esp)
...
8010466d:	8b 14 85 00 73 10 80 	mov    -0x7fef8d00(,%eax,4),%edx
...
80104684:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    curproc->tf->eax = syscalls[num]();
    //cprintf("%s\n", syscallnames[num]); //prints the syscall being used
  } else {
    cprintf("%d %s: unknown sys call %d\n",
...
80104696:	c7 04 24 d1 72 10 80 	movl   $0x801072d1,(%esp)
...
80104820:	c7 44 24 04 78 73 10 	movl   $0x80107378,0x4(%esp)
80104827:	80 
...
8010483b:	c7 44 24 04 77 73 10 	movl   $0x80107377,0x4(%esp)
80104842:	80 
...
80104851:	79 89                	jns    801047dc <create+0xdc>
      panic("create dots");
80104853:	c7 04 24 6b 73 10 80 	movl   $0x8010736b,(%esp)
8010485a:	e8 01 bb ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010485f:	c7 04 24 7a 73 10 80 	movl   $0x8010737a,(%esp)
80104866:	e8 f5 ba ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010486b:	c7 04 24 5c 73 10 80 	movl   $0x8010735c,(%esp)
...
80104c11:	c7 44 24 04 78 73 10 	movl   $0x80107378,0x4(%esp)
80104c18:	80 
...
80104c29:	c7 44 24 04 77 73 10 	movl   $0x80107377,0x4(%esp)
80104c30:	80 
...
80104d78:	e9 48 ff ff ff       	jmp    80104cc5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104d7d:	c7 04 24 9c 73 10 80 	movl   $0x8010739c,(%esp)
80104d84:	e8 d7 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104d89:	c7 04 24 ae 73 10 80 	movl   $0x801073ae,(%esp)
80104d90:	e8 cb b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104d95:	c7 04 24 8a 73 10 80 	movl   $0x8010738a,(%esp)
...
// defines rtcdate pointer, then calls cmostime 
int
sys_date(void)
{
...
801053b9:	c7 44 24 08 18 00 00 	movl   $0x18,0x8(%esp)
801053c0:	00 
801053c1:	89 44 24 04          	mov    %eax,0x4(%esp)
801053c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801053cc:	e8 df f1 ff ff       	call   801045b0 <argptr>
  cmostime(date);
801053d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053d4:	89 04 24             	mov    %eax,(%esp)
801053d7:	e8 74 d4 ff ff       	call   80102850 <cmostime>
  return 0;
...
801053ff:	83 c4 08             	add    $0x8,%esp
  iret
80105402:	cf                   	iret   
80105403:	66 90                	xchg   %ax,%ax
80105405:	66 90                	xchg   %ax,%ax
80105407:	66 90                	xchg   %ax,%ax
...
80105469:	c7 44 24 04 bd 73 10 	movl   $0x801073bd,0x4(%esp)
80105470:	80 
...
80105500:	ff 24 85 64 74 10 80 	jmp    *-0x7fef8b9c(,%eax,4)
80105507:	90                   	nop
    lapiceoi();
    break;
...
80105573:	c7 04 24 20 74 10 80 	movl   $0x80107420,(%esp)
...
80105619:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105620:	e8 6b e0 ff ff       	call   80103690 <cpuid>
...
8010562d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105630:	e8 5b d1 ff ff       	call   80102790 <lapiceoi>
    break;
...
80105640:	e8 9b cf ff ff       	call   801025e0 <kbdintr>
    lapiceoi();
80105645:	e8 46 d1 ff ff       	call   80102790 <lapiceoi>
    break;
...
80105650:	e8 1b 02 00 00       	call   80105870 <uartintr>
    lapiceoi();
80105655:	e8 36 d1 ff ff       	call   80102790 <lapiceoi>
    break;
...
80105667:	e8 24 e0 ff ff       	call   80103690 <cpuid>
8010566c:	c7 04 24 c8 73 10 80 	movl   $0x801073c8,(%esp)
...
8010567f:	e8 cc af ff ff       	call   80100650 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105684:	e8 07 d1 ff ff       	call   80102790 <lapiceoi>
    break;
...
801056a5:	8b 70 24             	mov    0x24(%eax),%esi
801056a8:	85 f6                	test   %esi,%esi
801056aa:	75 2c                	jne    801056d8 <trap+0x1f8>
      exit();
    myproc()->tf = tf;
801056ac:	e8 ff df ff ff       	call   801036b0 <myproc>
801056b1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801056b4:	e8 97 ef ff ff       	call   80104650 <syscall>
    if(myproc()->killed)
801056b9:	e8 f2 df ff ff       	call   801036b0 <myproc>
801056be:	8b 48 24             	mov    0x24(%eax),%ecx
...
801056cf:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801056d0:	e9 db e3 ff ff       	jmp    80103ab0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801056d8:	e8 d3 e3 ff ff       	call   80103ab0 <exit>
...
801056df:	90                   	nop
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
801056e0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801056e7:	e8 64 ea ff ff       	call   80104150 <acquire>
      ticks++;
      wakeup(&ticks);
801056ec:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
801056f3:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
801056fa:	e8 a1 e6 ff ff       	call   80103da0 <wakeup>
      release(&tickslock);
801056ff:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105706:	e8 35 eb ff ff       	call   80104240 <release>
...
80105716:	e8 75 df ff ff       	call   80103690 <cpuid>
...
8010572a:	c7 04 24 ec 73 10 80 	movl   $0x801073ec,(%esp)
80105731:	89 44 24 04          	mov    %eax,0x4(%esp)
80105735:	e8 16 af ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010573a:	c7 04 24 c2 73 10 80 	movl   $0x801073c2,(%esp)
...
801057a7:	e8 04 d0 ff ff       	call   801027b0 <microdelay>
{
  int i;
...
80105837:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105838:	bb e4 74 10 80       	mov    $0x801074e4,%ebx
...
80105844:	e8 77 ca ff ff       	call   801022c0 <ioapicenable>
...
80105886:	6a 00                	push   $0x0
  jmp alltraps
80105888:	e9 53 fb ff ff       	jmp    801053e0 <alltraps>
...
8010588f:	6a 01                	push   $0x1
  jmp alltraps
80105891:	e9 4a fb ff ff       	jmp    801053e0 <alltraps>
...
80105898:	6a 02                	push   $0x2
  jmp alltraps
8010589a:	e9 41 fb ff ff       	jmp    801053e0 <alltraps>
...
801058a1:	6a 03                	push   $0x3
  jmp alltraps
801058a3:	e9 38 fb ff ff       	jmp    801053e0 <alltraps>
...
801058aa:	6a 04                	push   $0x4
  jmp alltraps
801058ac:	e9 2f fb ff ff       	jmp    801053e0 <alltraps>
...
801058b3:	6a 05                	push   $0x5
  jmp alltraps
801058b5:	e9 26 fb ff ff       	jmp    801053e0 <alltraps>
...
801058bc:	6a 06                	push   $0x6
  jmp alltraps
801058be:	e9 1d fb ff ff       	jmp    801053e0 <alltraps>
...
801058c5:	6a 07                	push   $0x7
  jmp alltraps
801058c7:	e9 14 fb ff ff       	jmp    801053e0 <alltraps>
...
801058cc:	6a 08                	push   $0x8
  jmp alltraps
801058ce:	e9 0d fb ff ff       	jmp    801053e0 <alltraps>
...
801058d5:	6a 09                	push   $0x9
  jmp alltraps
801058d7:	e9 04 fb ff ff       	jmp    801053e0 <alltraps>
...
801058dc:	6a 0a                	push   $0xa
  jmp alltraps
801058de:	e9 fd fa ff ff       	jmp    801053e0 <alltraps>
...
801058e3:	6a 0b                	push   $0xb
  jmp alltraps
801058e5:	e9 f6 fa ff ff       	jmp    801053e0 <alltraps>
...
801058ea:	6a 0c                	push   $0xc
  jmp alltraps
801058ec:	e9 ef fa ff ff       	jmp    801053e0 <alltraps>
...
801058f1:	6a 0d                	push   $0xd
  jmp alltraps
801058f3:	e9 e8 fa ff ff       	jmp    801053e0 <alltraps>
...
801058f8:	6a 0e                	push   $0xe
  jmp alltraps
801058fa:	e9 e1 fa ff ff       	jmp    801053e0 <alltraps>
...
80105901:	6a 0f                	push   $0xf
  jmp alltraps
80105903:	e9 d8 fa ff ff       	jmp    801053e0 <alltraps>
...
8010590a:	6a 10                	push   $0x10
  jmp alltraps
8010590c:	e9 cf fa ff ff       	jmp    801053e0 <alltraps>
...
80105911:	6a 11                	push   $0x11
  jmp alltraps
80105913:	e9 c8 fa ff ff       	jmp    801053e0 <alltraps>
...
8010591a:	6a 12                	push   $0x12
  jmp alltraps
8010591c:	e9 bf fa ff ff       	jmp    801053e0 <alltraps>
...
80105923:	6a 13                	push   $0x13
  jmp alltraps
80105925:	e9 b6 fa ff ff       	jmp    801053e0 <alltraps>
...
8010592c:	6a 14                	push   $0x14
  jmp alltraps
8010592e:	e9 ad fa ff ff       	jmp    801053e0 <alltraps>
...
80105935:	6a 15                	push   $0x15
  jmp alltraps
80105937:	e9 a4 fa ff ff       	jmp    801053e0 <alltraps>
...
8010593e:	6a 16                	push   $0x16
  jmp alltraps
80105940:	e9 9b fa ff ff       	jmp    801053e0 <alltraps>
...
80105947:	6a 17                	push   $0x17
  jmp alltraps
80105949:	e9 92 fa ff ff       	jmp    801053e0 <alltraps>
...
80105950:	6a 18                	push   $0x18
  jmp alltraps
80105952:	e9 89 fa ff ff       	jmp    801053e0 <alltraps>
...
80105959:	6a 19                	push   $0x19
  jmp alltraps
8010595b:	e9 80 fa ff ff       	jmp    801053e0 <alltraps>
...
80105962:	6a 1a                	push   $0x1a
  jmp alltraps
80105964:	e9 77 fa ff ff       	jmp    801053e0 <alltraps>
...
8010596b:	6a 1b                	push   $0x1b
  jmp alltraps
8010596d:	e9 6e fa ff ff       	jmp    801053e0 <alltraps>
...
80105974:	6a 1c                	push   $0x1c
  jmp alltraps
80105976:	e9 65 fa ff ff       	jmp    801053e0 <alltraps>
...
8010597d:	6a 1d                	push   $0x1d
  jmp alltraps
8010597f:	e9 5c fa ff ff       	jmp    801053e0 <alltraps>
...
80105986:	6a 1e                	push   $0x1e
  jmp alltraps
80105988:	e9 53 fa ff ff       	jmp    801053e0 <alltraps>
...
8010598f:	6a 1f                	push   $0x1f
  jmp alltraps
80105991:	e9 4a fa ff ff       	jmp    801053e0 <alltraps>
...
801059b3:	6a 23                	push   $0x23
  jmp alltraps
801059b5:	e9 26 fa ff ff       	jmp    801053e0 <alltraps>
...
801059bc:	6a 24                	push   $0x24
  jmp alltraps
801059be:	e9 1d fa ff ff       	jmp    801053e0 <alltraps>
...
801059c5:	6a 25                	push   $0x25
  jmp alltraps
801059c7:	e9 14 fa ff ff       	jmp    801053e0 <alltraps>
...
801059ce:	6a 26                	push   $0x26
  jmp alltraps
801059d0:	e9 0b fa ff ff       	jmp    801053e0 <alltraps>
...
801059d7:	6a 27                	push   $0x27
  jmp alltraps
801059d9:	e9 02 fa ff ff       	jmp    801053e0 <alltraps>
...
801059e0:	6a 28                	push   $0x28
  jmp alltraps
801059e2:	e9 f9 f9 ff ff       	jmp    801053e0 <alltraps>
...
801059e9:	6a 29                	push   $0x29
  jmp alltraps
801059eb:	e9 f0 f9 ff ff       	jmp    801053e0 <alltraps>
...
801059f2:	6a 2a                	push   $0x2a
  jmp alltraps
801059f4:	e9 e7 f9 ff ff       	jmp    801053e0 <alltraps>
...
801059fb:	6a 2b                	push   $0x2b
  jmp alltraps
801059fd:	e9 de f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a04:	6a 2c                	push   $0x2c
  jmp alltraps
80105a06:	e9 d5 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a0d:	6a 2d                	push   $0x2d
  jmp alltraps
80105a0f:	e9 cc f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a16:	6a 2e                	push   $0x2e
  jmp alltraps
80105a18:	e9 c3 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a1f:	6a 2f                	push   $0x2f
  jmp alltraps
80105a21:	e9 ba f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a28:	6a 30                	push   $0x30
  jmp alltraps
80105a2a:	e9 b1 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a31:	6a 31                	push   $0x31
  jmp alltraps
80105a33:	e9 a8 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a3a:	6a 32                	push   $0x32
  jmp alltraps
80105a3c:	e9 9f f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a43:	6a 33                	push   $0x33
  jmp alltraps
80105a45:	e9 96 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a4c:	6a 34                	push   $0x34
  jmp alltraps
80105a4e:	e9 8d f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a55:	6a 35                	push   $0x35
  jmp alltraps
80105a57:	e9 84 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a5e:	6a 36                	push   $0x36
  jmp alltraps
80105a60:	e9 7b f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a67:	6a 37                	push   $0x37
  jmp alltraps
80105a69:	e9 72 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a70:	6a 38                	push   $0x38
  jmp alltraps
80105a72:	e9 69 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a79:	6a 39                	push   $0x39
  jmp alltraps
80105a7b:	e9 60 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a82:	6a 3a                	push   $0x3a
  jmp alltraps
80105a84:	e9 57 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a8b:	6a 3b                	push   $0x3b
  jmp alltraps
80105a8d:	e9 4e f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a94:	6a 3c                	push   $0x3c
  jmp alltraps
80105a96:	e9 45 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105a9d:	6a 3d                	push   $0x3d
  jmp alltraps
80105a9f:	e9 3c f9 ff ff       	jmp    801053e0 <alltraps>
...
80105aa6:	6a 3e                	push   $0x3e
  jmp alltraps
80105aa8:	e9 33 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105aaf:	6a 3f                	push   $0x3f
  jmp alltraps
80105ab1:	e9 2a f9 ff ff       	jmp    801053e0 <alltraps>
...
80105ab8:	6a 40                	push   $0x40
  jmp alltraps
80105aba:	e9 21 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105ac1:	6a 41                	push   $0x41
  jmp alltraps
80105ac3:	e9 18 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105aca:	6a 42                	push   $0x42
  jmp alltraps
80105acc:	e9 0f f9 ff ff       	jmp    801053e0 <alltraps>
...
80105ad3:	6a 43                	push   $0x43
  jmp alltraps
80105ad5:	e9 06 f9 ff ff       	jmp    801053e0 <alltraps>
...
80105adc:	6a 44                	push   $0x44
  jmp alltraps
80105ade:	e9 fd f8 ff ff       	jmp    801053e0 <alltraps>
...
80105ae5:	6a 45                	push   $0x45
  jmp alltraps
80105ae7:	e9 f4 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105aee:	6a 46                	push   $0x46
  jmp alltraps
80105af0:	e9 eb f8 ff ff       	jmp    801053e0 <alltraps>
...
80105af7:	6a 47                	push   $0x47
  jmp alltraps
80105af9:	e9 e2 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b00:	6a 48                	push   $0x48
  jmp alltraps
80105b02:	e9 d9 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b09:	6a 49                	push   $0x49
  jmp alltraps
80105b0b:	e9 d0 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b12:	6a 4a                	push   $0x4a
  jmp alltraps
80105b14:	e9 c7 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b1b:	6a 4b                	push   $0x4b
  jmp alltraps
80105b1d:	e9 be f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b24:	6a 4c                	push   $0x4c
  jmp alltraps
80105b26:	e9 b5 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b2d:	6a 4d                	push   $0x4d
  jmp alltraps
80105b2f:	e9 ac f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b36:	6a 4e                	push   $0x4e
  jmp alltraps
80105b38:	e9 a3 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b3f:	6a 4f                	push   $0x4f
  jmp alltraps
80105b41:	e9 9a f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b48:	6a 50                	push   $0x50
  jmp alltraps
80105b4a:	e9 91 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b51:	6a 51                	push   $0x51
  jmp alltraps
80105b53:	e9 88 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b5a:	6a 52                	push   $0x52
  jmp alltraps
80105b5c:	e9 7f f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b63:	6a 53                	push   $0x53
  jmp alltraps
80105b65:	e9 76 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b6c:	6a 54                	push   $0x54
  jmp alltraps
80105b6e:	e9 6d f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b75:	6a 55                	push   $0x55
  jmp alltraps
80105b77:	e9 64 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b7e:	6a 56                	push   $0x56
  jmp alltraps
80105b80:	e9 5b f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b87:	6a 57                	push   $0x57
  jmp alltraps
80105b89:	e9 52 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b90:	6a 58                	push   $0x58
  jmp alltraps
80105b92:	e9 49 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105b99:	6a 59                	push   $0x59
  jmp alltraps
80105b9b:	e9 40 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105ba2:	6a 5a                	push   $0x5a
  jmp alltraps
80105ba4:	e9 37 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105bab:	6a 5b                	push   $0x5b
  jmp alltraps
80105bad:	e9 2e f8 ff ff       	jmp    801053e0 <alltraps>
...
80105bb4:	6a 5c                	push   $0x5c
  jmp alltraps
80105bb6:	e9 25 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105bbd:	6a 5d                	push   $0x5d
  jmp alltraps
80105bbf:	e9 1c f8 ff ff       	jmp    801053e0 <alltraps>
...
80105bc6:	6a 5e                	push   $0x5e
  jmp alltraps
80105bc8:	e9 13 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105bcf:	6a 5f                	push   $0x5f
  jmp alltraps
80105bd1:	e9 0a f8 ff ff       	jmp    801053e0 <alltraps>
...
80105bd8:	6a 60                	push   $0x60
  jmp alltraps
80105bda:	e9 01 f8 ff ff       	jmp    801053e0 <alltraps>
...
80105be1:	6a 61                	push   $0x61
  jmp alltraps
80105be3:	e9 f8 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105bea:	6a 62                	push   $0x62
  jmp alltraps
80105bec:	e9 ef f7 ff ff       	jmp    801053e0 <alltraps>
...
80105bf3:	6a 63                	push   $0x63
  jmp alltraps
80105bf5:	e9 e6 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105bfc:	6a 64                	push   $0x64
  jmp alltraps
80105bfe:	e9 dd f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c05:	6a 65                	push   $0x65
  jmp alltraps
80105c07:	e9 d4 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c0e:	6a 66                	push   $0x66
  jmp alltraps
80105c10:	e9 cb f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c17:	6a 67                	push   $0x67
  jmp alltraps
80105c19:	e9 c2 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c20:	6a 68                	push   $0x68
  jmp alltraps
80105c22:	e9 b9 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c29:	6a 69                	push   $0x69
  jmp alltraps
80105c2b:	e9 b0 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c32:	6a 6a                	push   $0x6a
  jmp alltraps
80105c34:	e9 a7 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c3b:	6a 6b                	push   $0x6b
  jmp alltraps
80105c3d:	e9 9e f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c44:	6a 6c                	push   $0x6c
  jmp alltraps
80105c46:	e9 95 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c4d:	6a 6d                	push   $0x6d
  jmp alltraps
80105c4f:	e9 8c f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c56:	6a 6e                	push   $0x6e
  jmp alltraps
80105c58:	e9 83 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c5f:	6a 6f                	push   $0x6f
  jmp alltraps
80105c61:	e9 7a f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c68:	6a 70                	push   $0x70
  jmp alltraps
80105c6a:	e9 71 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c71:	6a 71                	push   $0x71
  jmp alltraps
80105c73:	e9 68 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c7a:	6a 72                	push   $0x72
  jmp alltraps
80105c7c:	e9 5f f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c83:	6a 73                	push   $0x73
  jmp alltraps
80105c85:	e9 56 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c8c:	6a 74                	push   $0x74
  jmp alltraps
80105c8e:	e9 4d f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c95:	6a 75                	push   $0x75
  jmp alltraps
80105c97:	e9 44 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105c9e:	6a 76                	push   $0x76
  jmp alltraps
80105ca0:	e9 3b f7 ff ff       	jmp    801053e0 <alltraps>
...
80105ca7:	6a 77                	push   $0x77
  jmp alltraps
80105ca9:	e9 32 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105cb0:	6a 78                	push   $0x78
  jmp alltraps
80105cb2:	e9 29 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105cb9:	6a 79                	push   $0x79
  jmp alltraps
80105cbb:	e9 20 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105cc2:	6a 7a                	push   $0x7a
  jmp alltraps
80105cc4:	e9 17 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105ccb:	6a 7b                	push   $0x7b
  jmp alltraps
80105ccd:	e9 0e f7 ff ff       	jmp    801053e0 <alltraps>
...
80105cd4:	6a 7c                	push   $0x7c
  jmp alltraps
80105cd6:	e9 05 f7 ff ff       	jmp    801053e0 <alltraps>
...
80105cdd:	6a 7d                	push   $0x7d
  jmp alltraps
80105cdf:	e9 fc f6 ff ff       	jmp    801053e0 <alltraps>
...
80105ce6:	6a 7e                	push   $0x7e
  jmp alltraps
80105ce8:	e9 f3 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105cef:	6a 7f                	push   $0x7f
  jmp alltraps
80105cf1:	e9 ea f6 ff ff       	jmp    801053e0 <alltraps>
...
80105cf8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105cfd:	e9 de f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d04:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105d09:	e9 d2 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d10:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105d15:	e9 c6 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d1c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105d21:	e9 ba f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d28:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105d2d:	e9 ae f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d34:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105d39:	e9 a2 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d40:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105d45:	e9 96 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d4c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105d51:	e9 8a f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d58:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105d5d:	e9 7e f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d64:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105d69:	e9 72 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d70:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105d75:	e9 66 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d7c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105d81:	e9 5a f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d88:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105d8d:	e9 4e f6 ff ff       	jmp    801053e0 <alltraps>
...
80105d94:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105d99:	e9 42 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105da0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105da5:	e9 36 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105dac:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105db1:	e9 2a f6 ff ff       	jmp    801053e0 <alltraps>
...
80105db8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105dbd:	e9 1e f6 ff ff       	jmp    801053e0 <alltraps>
...
80105dc4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105dc9:	e9 12 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105dd0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105dd5:	e9 06 f6 ff ff       	jmp    801053e0 <alltraps>
...
80105ddc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105de1:	e9 fa f5 ff ff       	jmp    801053e0 <alltraps>
...
80105de8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105ded:	e9 ee f5 ff ff       	jmp    801053e0 <alltraps>
...
80105df4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105df9:	e9 e2 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e00:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105e05:	e9 d6 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e0c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105e11:	e9 ca f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e18:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105e1d:	e9 be f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e24:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105e29:	e9 b2 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e30:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105e35:	e9 a6 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e3c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105e41:	e9 9a f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e48:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105e4d:	e9 8e f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e54:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105e59:	e9 82 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e60:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105e65:	e9 76 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e6c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105e71:	e9 6a f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e78:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105e7d:	e9 5e f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e84:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105e89:	e9 52 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e90:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105e95:	e9 46 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105e9c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105ea1:	e9 3a f5 ff ff       	jmp    801053e0 <alltraps>
...
80105ea8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105ead:	e9 2e f5 ff ff       	jmp    801053e0 <alltraps>
...
80105eb4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105eb9:	e9 22 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105ec0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105ec5:	e9 16 f5 ff ff       	jmp    801053e0 <alltraps>
...
80105ecc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105ed1:	e9 0a f5 ff ff       	jmp    801053e0 <alltraps>
...
80105ed8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105edd:	e9 fe f4 ff ff       	jmp    801053e0 <alltraps>
...
80105ee4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105ee9:	e9 f2 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105ef0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105ef5:	e9 e6 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105efc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105f01:	e9 da f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f08:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105f0d:	e9 ce f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f14:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105f19:	e9 c2 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f20:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105f25:	e9 b6 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f2c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105f31:	e9 aa f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f38:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105f3d:	e9 9e f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f44:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105f49:	e9 92 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f50:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105f55:	e9 86 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f5c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105f61:	e9 7a f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f68:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105f6d:	e9 6e f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f74:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105f79:	e9 62 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f80:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105f85:	e9 56 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f8c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105f91:	e9 4a f4 ff ff       	jmp    801053e0 <alltraps>
...
80105f98:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105f9d:	e9 3e f4 ff ff       	jmp    801053e0 <alltraps>
...
80105fa4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105fa9:	e9 32 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105fb0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105fb5:	e9 26 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105fbc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105fc1:	e9 1a f4 ff ff       	jmp    801053e0 <alltraps>
...
80105fc8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105fcd:	e9 0e f4 ff ff       	jmp    801053e0 <alltraps>
...
80105fd4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105fd9:	e9 02 f4 ff ff       	jmp    801053e0 <alltraps>
...
80105fe0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105fe5:	e9 f6 f3 ff ff       	jmp    801053e0 <alltraps>
...
80105fec:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80105ff1:	e9 ea f3 ff ff       	jmp    801053e0 <alltraps>
...
80105ff8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105ffd:	e9 de f3 ff ff       	jmp    801053e0 <alltraps>
...
80106004:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106009:	e9 d2 f3 ff ff       	jmp    801053e0 <alltraps>
...
80106010:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106015:	e9 c6 f3 ff ff       	jmp    801053e0 <alltraps>
...
8010601c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106021:	e9 ba f3 ff ff       	jmp    801053e0 <alltraps>
...
80106028:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010602d:	e9 ae f3 ff ff       	jmp    801053e0 <alltraps>
...
80106034:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106039:	e9 a2 f3 ff ff       	jmp    801053e0 <alltraps>
...
80106040:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106045:	e9 96 f3 ff ff       	jmp    801053e0 <alltraps>
...
8010604c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106051:	e9 8a f3 ff ff       	jmp    801053e0 <alltraps>
...
80106058:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010605d:	e9 7e f3 ff ff       	jmp    801053e0 <alltraps>
...
80106064:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106069:	e9 72 f3 ff ff       	jmp    801053e0 <alltraps>
...
80106070:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106075:	e9 66 f3 ff ff       	jmp    801053e0 <alltraps>
...
8010607c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106081:	e9 5a f3 ff ff       	jmp    801053e0 <alltraps>
...
80106088:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010608d:	e9 4e f3 ff ff       	jmp    801053e0 <alltraps>
...
80106094:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106099:	e9 42 f3 ff ff       	jmp    801053e0 <alltraps>
...
801060a0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801060a5:	e9 36 f3 ff ff       	jmp    801053e0 <alltraps>
...
801060ac:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801060b1:	e9 2a f3 ff ff       	jmp    801053e0 <alltraps>
...
801060b8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801060bd:	e9 1e f3 ff ff       	jmp    801053e0 <alltraps>
...
801060c4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801060c9:	e9 12 f3 ff ff       	jmp    801053e0 <alltraps>
...
801060d0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801060d5:	e9 06 f3 ff ff       	jmp    801053e0 <alltraps>
...
801060dc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801060e1:	e9 fa f2 ff ff       	jmp    801053e0 <alltraps>
...
801060e8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801060ed:	e9 ee f2 ff ff       	jmp    801053e0 <alltraps>
...
801060f4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801060f9:	e9 e2 f2 ff ff       	jmp    801053e0 <alltraps>
...
80106100:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106105:	e9 d6 f2 ff ff       	jmp    801053e0 <alltraps>
...
8010610c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106111:	e9 ca f2 ff ff       	jmp    801053e0 <alltraps>
...
80106118:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010611d:	e9 be f2 ff ff       	jmp    801053e0 <alltraps>
...
80106124:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106129:	e9 b2 f2 ff ff       	jmp    801053e0 <alltraps>
...
80106130:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106135:	e9 a6 f2 ff ff       	jmp    801053e0 <alltraps>
...
8010613c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106141:	e9 9a f2 ff ff       	jmp    801053e0 <alltraps>
...
80106148:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010614d:	e9 8e f2 ff ff       	jmp    801053e0 <alltraps>
...
80106154:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106159:	e9 82 f2 ff ff       	jmp    801053e0 <alltraps>
...
80106160:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106165:	e9 76 f2 ff ff       	jmp    801053e0 <alltraps>
...
8010616c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106171:	e9 6a f2 ff ff       	jmp    801053e0 <alltraps>
...
80106178:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010617d:	e9 5e f2 ff ff       	jmp    801053e0 <alltraps>
...
80106184:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106189:	e9 52 f2 ff ff       	jmp    801053e0 <alltraps>
...
80106190:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106195:	e9 46 f2 ff ff       	jmp    801053e0 <alltraps>
...
8010619c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801061a1:	e9 3a f2 ff ff       	jmp    801053e0 <alltraps>
...
801061a8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801061ad:	e9 2e f2 ff ff       	jmp    801053e0 <alltraps>
...
801061b4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801061b9:	e9 22 f2 ff ff       	jmp    801053e0 <alltraps>
...
801061c0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801061c5:	e9 16 f2 ff ff       	jmp    801053e0 <alltraps>
...
801061cc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801061d1:	e9 0a f2 ff ff       	jmp    801053e0 <alltraps>
...
801061d8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801061dd:	e9 fe f1 ff ff       	jmp    801053e0 <alltraps>
...
801061e4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801061e9:	e9 f2 f1 ff ff       	jmp    801053e0 <alltraps>
...
801061f0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801061f5:	e9 e6 f1 ff ff       	jmp    801053e0 <alltraps>
...
801061fc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106201:	e9 da f1 ff ff       	jmp    801053e0 <alltraps>
...
80106208:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010620d:	e9 ce f1 ff ff       	jmp    801053e0 <alltraps>
...
80106214:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106219:	e9 c2 f1 ff ff       	jmp    801053e0 <alltraps>
...
80106220:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106225:	e9 b6 f1 ff ff       	jmp    801053e0 <alltraps>
...
8010622c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106231:	e9 aa f1 ff ff       	jmp    801053e0 <alltraps>
...
80106238:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010623d:	e9 9e f1 ff ff       	jmp    801053e0 <alltraps>
...
80106244:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106249:	e9 92 f1 ff ff       	jmp    801053e0 <alltraps>
...
80106250:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106255:	e9 86 f1 ff ff       	jmp    801053e0 <alltraps>
...
8010625c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106261:	e9 7a f1 ff ff       	jmp    801053e0 <alltraps>
...
80106268:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010626d:	e9 6e f1 ff ff       	jmp    801053e0 <alltraps>
...
80106274:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106279:	e9 62 f1 ff ff       	jmp    801053e0 <alltraps>
...
80106280:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106285:	e9 56 f1 ff ff       	jmp    801053e0 <alltraps>
...
8010628c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106291:	e9 4a f1 ff ff       	jmp    801053e0 <alltraps>
...
80106298:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010629d:	e9 3e f1 ff ff       	jmp    801053e0 <alltraps>
...
801062a4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801062a9:	e9 32 f1 ff ff       	jmp    801053e0 <alltraps>
...
801062b0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801062b5:	e9 26 f1 ff ff       	jmp    801053e0 <alltraps>
...
801062bc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801062c1:	e9 1a f1 ff ff       	jmp    801053e0 <alltraps>
...
801062c8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801062cd:	e9 0e f1 ff ff       	jmp    801053e0 <alltraps>
...
801062d4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801062d9:	e9 02 f1 ff ff       	jmp    801053e0 <alltraps>
...
801062e0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801062e5:	e9 f6 f0 ff ff       	jmp    801053e0 <alltraps>
...
801062ec:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801062f1:	e9 ea f0 ff ff       	jmp    801053e0 <alltraps>
...
80106344:	e8 67 c1 ff ff       	call   801024b0 <kalloc>
...
80106362:	e8 29 df ff ff       	call   80104290 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106401:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106402:	c7 04 24 ec 74 10 80 	movl   $0x801074ec,(%esp)
...
80106453:	e8 a8 be ff ff       	call   80102300 <kfree>
      *pte = 0;
...
801064b3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801064b6:	e8 d5 d1 ff ff       	call   80103690 <cpuid>
...
80106570:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
801065b4:	0f 84 c3 00 00 00    	je     8010667d <switchuvm+0xed>
  ...
  pushcli();
801065ba:	e8 51 db ff ff       	call   80104110 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801065bf:	e8 4c d0 ff ff       	call   80103610 <mycpu>
801065c4:	89 c3                	mov    %eax,%ebx
801065c6:	e8 45 d0 ff ff       	call   80103610 <mycpu>
801065cb:	89 c7                	mov    %eax,%edi
801065cd:	e8 3e d0 ff ff       	call   80103610 <mycpu>
801065d2:	83 c7 08             	add    $0x8,%edi
801065d5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801065d8:	e8 33 d0 ff ff       	call   80103610 <mycpu>
...
80106619:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010661e:	e8 ed cf ff ff       	call   80103610 <mycpu>
80106623:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010662a:	e8 e1 cf ff ff       	call   80103610 <mycpu>
...
80106646:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106649:	e8 c2 cf ff ff       	call   80103610 <mycpu>
...
8010666b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010666c:	e9 5f db ff ff       	jmp    801041d0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106671:	c7 04 24 f2 74 10 80 	movl   $0x801074f2,(%esp)
80106678:	e8 e3 9c ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010667d:	c7 04 24 1d 75 10 80 	movl   $0x8010751d,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80106689:	c7 04 24 08 75 10 80 	movl   $0x80107508,(%esp)
...
801066bb:	77 54                	ja     80106711 <inituvm+0x71>
  ...
  mem = kalloc();
801066bd:	e8 ee bd ff ff       	call   801024b0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801066d7:	e8 b4 db ff ff       	call   80104290 <memset>
...
8010670b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010670c:	e9 1f dc ff ff       	jmp    80104330 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80106711:	c7 04 24 31 75 10 80 	movl   $0x80107531,(%esp)
...
8010679d:	e8 ce b1 ff ff       	call   80101970 <readi>
...
801067c1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801067c2:	c7 04 24 4b 75 10 80 	movl   $0x8010754b,(%esp)
801067c9:	e8 92 9b ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801067ce:	c7 04 24 ec 75 10 80 	movl   $0x801075ec,(%esp)
...
80106823:	e8 68 da ff ff       	call   80104290 <memset>
...
80106854:	76 2a                	jbe    80106880 <allocuvm+0xa0>
    mem = kalloc();
80106856:	e8 55 bc ff ff       	call   801024b0 <kalloc>
    if(mem == 0){
...
8010685f:	75 af                	jne    80106810 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106861:	c7 04 24 69 75 10 80 	movl   $0x80107569,(%esp)
...
8010688a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106890:	c7 04 24 81 75 10 80 	movl   $0x80107581,(%esp)
...
801068b1:	e8 4a ba ff ff       	call   80102300 <kfree>
      return 0;
...
8010693d:	e8 be b9 ff ff       	call   80102300 <kfree>
  uint i;
...
80106952:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106953:	e9 a8 b9 ff ff       	jmp    80102300 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106958:	c7 04 24 9d 75 10 80 	movl   $0x8010759d,(%esp)
...
80106978:	e8 33 bb ff ff       	call   801024b0 <kalloc>
...
8010699b:	e8 f0 d8 ff ff       	call   80104290 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106a0b:	a3 a4 54 11 80       	mov    %eax,0x801154a4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106a3b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106a3c:	c7 04 24 ae 75 10 80 	movl   $0x801075ae,(%esp)
...
80106a63:	0f 84 b2 00 00 00    	je     80106b1b <copyuvm+0xcb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106a69:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a6c:	85 c0                	test   %eax,%eax
80106a6e:	0f 84 9c 00 00 00    	je     80106b10 <copyuvm+0xc0>
...
80106ab3:	78 41                	js     80106af6 <copyuvm+0xa6>
  uint pa, i, flags;
  char *mem;
...
80106abb:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106abe:	76 50                	jbe    80106b10 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106ac0:	8b 45 08             	mov    0x8(%ebp),%eax
80106ac3:	31 c9                	xor    %ecx,%ecx
80106ac5:	89 da                	mov    %ebx,%edx
80106ac7:	e8 34 f8 ff ff       	call   80106300 <walkpgdir>
80106acc:	85 c0                	test   %eax,%eax
80106ace:	74 5b                	je     80106b2b <copyuvm+0xdb>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106ad0:	8b 30                	mov    (%eax),%esi
80106ad2:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106ad8:	74 45                	je     80106b1f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106ada:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106adc:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106ae2:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106ae5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106aeb:	e8 c0 b9 ff ff       	call   801024b0 <kalloc>
80106af0:	85 c0                	test   %eax,%eax
80106af2:	89 c6                	mov    %eax,%esi
80106af4:	75 82                	jne    80106a78 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
bad:
  freevm(d);
80106af6:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106af9:	89 04 24             	mov    %eax,(%esp)
80106afc:	e8 ef fd ff ff       	call   801068f0 <freevm>
  return 0;
...
80106b13:	83 c4 2c             	add    $0x2c,%esp
80106b16:	5b                   	pop    %ebx
80106b17:	5e                   	pop    %esi
80106b18:	5f                   	pop    %edi
80106b19:	5d                   	pop    %ebp
...
80106b1d:	eb e4                	jmp    80106b03 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106b1f:	c7 04 24 d2 75 10 80 	movl   $0x801075d2,(%esp)
80106b26:	e8 35 98 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106b2b:	c7 04 24 b8 75 10 80 	movl   $0x801075b8,(%esp)
80106b32:	e8 29 98 ff ff       	call   80100360 <panic>
...
80106bbc:	e8 6f d7 ff ff       	call   80104330 <memmove>
    len -= n;
    buf += n;
